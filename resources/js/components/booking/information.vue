        ...
        <div class="container mx-auto">
            ...
            <div class="mb-4 border-b mt-5">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="overview-tab" data-tabs-target="#overview" type="button" role="tab" aria-controls="overview" aria-selected="false">Overviews</button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button class="inline-block p-4 border-b-2 rounded-t-lg" id="room-tab" data-tabs-target="#room" type="button" role="tab" aria-controls="room" aria-selected="false">Rooms</button>
                    </li>
                </ul>
            </div>
            <!-- overview -->
            <div class="hidden" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                <div class="p-7 rounded-lg border-tab">
                    <h4 class="text-xl font-bold mb-2 text-main">Address</h4>
                    <p class="text-base mb-4 text-main">{{ address }}</p>
                    <h4 class="text-xl font-bold mb-2 text-main">About</h4>
                    <p class="text-base mb-4 text-about text-wrap text-main">{{ about }}</p>
                    <h4 class="text-xl font-bold mb-2 text-main">Near</h4>
                    <div class="flex flex-wrap">
                        <span class="bg-blue-500 hover:bg-blue-400 text-white text-xs font-medium me-2 px-2.5 py-0.5 rounded border-gray-500 cursor-pointer" v-for="(item, index) in near" :key="index">{{item}}</span>
                    </div>
                </div>
            </div>
            <!-- room -->
