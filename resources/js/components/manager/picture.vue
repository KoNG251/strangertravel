    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card p-10">
                ...
                <div class="fv-row">
                    <form ref="dropzone" class="dropzone mb-7"></form>
            ...
            methods: {
                ...
                initializeDropzone() {
                    this.dropzone = new Dropzone(this.$refs.dropzone, {
                        url: '/dummy-url', // Provide a dummy URL
                        autoProcessQueue: false, // Prevent auto upload
                        maxFilesize: 2, // Max file size in MB
                        acceptedFiles: 'image/*', // Accepted file types, change as needed
                        init: function () {
                ...
                submitFiles() {
                    ...
                    for (const file of this.dropzone.getAcceptedFiles()) {
                    formData.append('file[]', file);
                    }
                    formData.append('_token', this.csrfToken);

                    axios.post('/manager/api/store/chunks?id='+id, formData, {
                        headers: {
