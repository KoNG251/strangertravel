        ...
        >
            ...
            <div class="d-flex align-items-center flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-2 ms-lg-3">
                    ...
                    >
                        <i
                            class="ki-duotone ki-night-day theme-light-show fs-2x"
                        >
                ...
                <div class="col-xxl-6 mb-md-5 mb-xl-10">
                    ...
                    <div class="row g-5 g-xl-10">
                        ...
                        <div class="col-md-6 col-xl-6 mb-xxl-10">
                            <!--begin::Card widget 8-->
                            <div
                                class="card overflow-hidden h-md-50 mb-5 mb-xl-10"
                            >
                                <!--begin::Card body-->
                                <div
                                ...
                                >
                                    ...
                                    <div class="mb-4 px-9">
                                        ...
                                        <span
                                            ...
                                            >Booking Today</span
                                        >
                                        <div class="d-flex gap-x-4 mt-5"></div>
                                        <!--end::Description-->
                                    </div>
                                    <div
                                        id="kt_card_widget_7_chart"
                                        class="min-h-auto"
                                        style="height: 125px"
                                    ></div>
                                    <!--end::Statistics-->
                        ...
                        >
                            <thead>
                                ...
                                >
                                    ...
                                    <th class="min-w-125px">Room number</th>
                                    <th class="w-125px"></th>
                                </tr>
                            </thead>
                            <tbody class="fw-semibold text-gray-600">
                                <tr v-for="(people, index) in checkInToday" :key="index">
                                    <td>{{ index+1 }}</td>
                ...
                <div class="card card-flush">
                    ...
                    <div class="px-8 table-responsive">
                        ...
                        >
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                <tr v-for="(people, index) in checkOutToday" :key="index">
                                    <td>{{ index+1 }}</td>
                                    <td>{{ people.fname+' '+people.lname }}</td>
                                    <td>{{ people.tel }}</td>
                                    <td>{{ people.room }}</td>
...
export default {
    ...
    methods: {
        ...
        renderDonutChart() {
            ...
            const chartData = {
                labels: this.chart.map(item => moment(item.date).format('DD MMMM YYYY')),
                datasets: [{
                backgroundColor: ['#2C5D9E', '#628acf', '#c9ecff', '#4AA0D5','#004774','#0B1E3F','#1e2d50','#38456a'],
                data: this.chart.map(item => item.total_price)
                }]
            };
    ...
    async mounted() {
        ...
        await axios
            .get("/manager/api/get/dashboard/information")
            .then((response) => {
                this.bookingToday = response.data.message.bookingToday;
                this.amountPrice = response.data.message.amountPrice;
                this.checkInToday = response.data.message.checkInToday;
                this.checkOutToday = response.data.message.checkOutToday;
                this.allRoomCount = response.data.message.allRoomCount;
                this.allHotelCount = response.data.message.allHotelCount;
                this.chart = response.data.message.chart;
            });
