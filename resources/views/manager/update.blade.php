			...
			<div class="page d-flex flex-row flex-column-fluid">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item py-2">
										...
										<div class="menu-sub menu-sub-indention menu-sub-dropdown w-225px px-2 py-4">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="{{ route('manager.cms.home') }}" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item py-2">
										...
										<div class="menu-sub menu-sub-indention menu-sub-dropdown w-225px px-2 py-4">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="{{ route('manager.cms.authentication') }}" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
													<span class="menu-icon">
									...
									<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item py-2">
										...
										<div class="menu-sub menu-sub-indention menu-sub-dropdown w-225px px-2 py-4">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="{{ route('manager.cms.add') }}" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
													<span class="menu-icon">
												...
												<a class="menu-link" href="{{ route('manager.cms.edit') }}" title="Check out over 200 in-house components, plugins and ready for use solutions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
													<span class="menu-icon">
							...
							<div class="menu menu-sub-indention menu-rounded menu-column menu-active-bg menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-arrow-gray-500 fw-semibold fs-6 my-5 mt-lg-2 mb-lg-0" id="kt_aside_menu" data-kt-menu="true">
								<div id="kt_aside_menu_wrapper" class="hover-scroll-y me-lg-n4 pe-lg-4" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-offset="20px" data-kt-scroll-wrappers="#kt_aside_wordspace">
									...
									<div class="menu-item">
										...
										<a class="menu-link active" href="{{ route('manager.cms.edit') }}">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Edit hotel</span>
                ...
                <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <manager-update
                        ...
                        :hotel-route="'{{ asset('storage/hotelPicture/') }}'"
                        :update-room-route="'{{ route('manager.view.update.room') }}'"
                    >
                    </manager-update>
                    </div>
                </div>
